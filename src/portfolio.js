...
// Navigation Bar Name
export const navbar_name = "Pankaj";
...
export const aboutme = {
  imgLink: "Images/PankajHD.png",
  p1: "Hey, My name is Pankaj Kumar Ram. A passionate individual who always thrive to work on end to end products.",
  p2: "I'm a Tech Enthusiast who enjoys building awesome website that solves real world problems.",
  p3: "Innovative, task-driven professional in web-designing, proficient in developing databases, user interfaces, writing & testing Codes, and implementing the features based on the feedback.",
};
...
export const whatido = {
  ...
  details: [
    "Building responsive website using React & Redux",
    "Creating backend application in Node & Express",
    "Building Simple RESTful CRUD APIs",
    "Core Knowledge of JavaScript Language",
  ],
  logos: [
    {
      name: "HTML5",
    ...
    {
      name: "Nextjs",
      iconifyClassName: "logos:nextjs",
      id: "13",
    },
    {
      name: "TypeScript",
      iconifyClassName: "logos:typescript",
      id: "14",
    },
  ],
};
...
export const details = [
  {
    ...
    link: "Tech Stack : React, Redux, ChakraUi, Node.Js, Express, MongoDb.",
    github: "https://github.com/Saraswati121/imported-existence-8823",
  ...
  },
  {
    ...
    link: "Tech Stack : React, Redux, Css, Javascript",
    github: "https://github.com/Pankaj1947/Boat_LifeStyle",
...
// Social Media Links
export const links = [
  "https://www.linkedin.com/in/pankaj-kumar-ram-639437190/",
  "https://github.com/Pankaj1947",

  "mailto:pankajkr885@gmail.com",
];
